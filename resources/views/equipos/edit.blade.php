...
<div class="py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        ...
        @can('eliminar equipos')
        <form id="delete-team-form" method="POST" action="{{ route('equipos.destroy', $equipo) }}" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este equipo? Esta acción no se puede deshacer y se eliminarán todos los miembros.');" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
        @endcan
