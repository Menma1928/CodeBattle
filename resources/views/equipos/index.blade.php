...
<div class="py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <!-- Search Bar -->
        <x-card class="mb-6">
            <form method="GET" action="{{ isset($isMyTeams) && $isMyTeams ? route('equipos.misEquipos') : route('equipos.index') }}" class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                    <x-text-input
                        name="search"
                        type="text"
                ...
                <div class="flex gap-2">
                    ...
                    @if(request('search'))
                    <a href="{{ isset($isMyTeams) && $isMyTeams ? route('equipos.misEquipos') : route('equipos.index') }}">
